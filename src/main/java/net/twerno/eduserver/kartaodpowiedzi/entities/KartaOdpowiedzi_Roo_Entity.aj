...
import net.twerno.eduserver.kartaodpowiedzi.entities.KartaOdpowiedzi;
...
privileged aspect KartaOdpowiedzi_Roo_Entity {
    ...
    @Column(name = "id")
    private Long KartaOdpowiedzi.id;
    
    @Version
    @Column(name = "version")
    private Integer KartaOdpowiedzi.version;
    
    public Long KartaOdpowiedzi.getId() {
        return this.id;
    }
    
    public void KartaOdpowiedzi.setId(Long id) {
        this.id = id;
    }
    ...
    public static KartaOdpowiedzi KartaOdpowiedzi.findKartaOdpowiedzi(Long id) {
