...
privileged aspect Zadanie_Zasady_Roo_JavaBean {
    ...
    public String Zadanie_Zasady.getId() {
        return this.id;
    }
    ...
    public void Zadanie_Zasady.setCzas_bronze(int czas_bronze) {
        this.czas_bronze = czas_bronze;
    }
    
    public int Zadanie_Zasady.getCzas_silver() {
        return this.czas_silver;
    }
    
    public void Zadanie_Zasady.setCzas_silver(int czas_silver) {
        this.czas_silver = czas_silver;
    }
    
    public int Zadanie_Zasady.getCzas_gold() {
        return this.czas_gold;
    }
    
    public void Zadanie_Zasady.setCzas_gold(int czas_gold) {
        this.czas_gold = czas_gold;
    }
    
    public int Zadanie_Zasady.getPunkty_bronze() {
        return this.punkty_bronze;
    }
    
    public void Zadanie_Zasady.setPunkty_bronze(int punkty_bronze) {
        this.punkty_bronze = punkty_bronze;
    }
    
    public int Zadanie_Zasady.getPunkty_silver() {
        return this.punkty_silver;
    }
    
    public void Zadanie_Zasady.setPunkty_silver(int punkty_silver) {
        this.punkty_silver = punkty_silver;
    }
    
    public int Zadanie_Zasady.getPunkty_gold() {
        return this.punkty_gold;
    }
    
    public void Zadanie_Zasady.setPunkty_gold(int punkty_gold) {
